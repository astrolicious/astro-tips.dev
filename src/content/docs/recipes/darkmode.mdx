...
This recipe will be for two components, one that managers the themes and creates the API that provides the nice DX, and one that the client interacts with to manually select the theme of their choosing. We will also go over styling and usage of the components.
...
- Uses [Web Components](https://developer.mozilla.org/en-US/docs/Web/API/Web_components) for nice DX and easy [View Transitions](https://docs.astro.build/en/guides/view-transitions/) compatibility
