...
- Includes a [`<select>`](#theme-select-component) toggling component (which isn't necesary to use the `ThemeManager.astro` component) in this recipe and a [`<button>`](https://github.com/astrolicious/astro-tips.dev/tree/main/examples/darkmode/src/components/ThemeToggle.astro) in the [example](https://github.com/astrolicious/astro-tips.dev/tree/main/examples/darkmode) on GitHub
