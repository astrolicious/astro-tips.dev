...
3 powerful zod features that cover basic needs.

### `preprocess`

People often want a bit more customization regarding how they reference images inside their frontmatter. For instance:
