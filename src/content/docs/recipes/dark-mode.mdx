...
If you're using ESLint there's a good chance you'll run into `'theme' is not defined` due to the [no-undef](https://eslint.org/docs/latest/rules/no-undef) rule. To solve this we can add `theme` as a global:
